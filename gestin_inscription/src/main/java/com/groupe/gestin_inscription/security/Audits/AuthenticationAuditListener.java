...
public class AuthenticationAuditListener {
    ...
    public void onSuccess(AuthenticationSuccessEvent event) {
        try {
            ...
            System.out.println("[AUDIT] Successful login attempt saved for user: " + username + " from IP: " + ipAddress);
        } catch (Exception e) {
    ...
    public void onFailure(AbstractAuthenticationFailureEvent event) {
        try {
            ...
            loginAttemptRepository.save(attempt);
            System.out.println("[AUDIT] Failed login attempt saved for user: " + username + " from IP: " + ipAddress);
        } catch (Exception e) {
            // Log the error but don't let it break the authentication flow
